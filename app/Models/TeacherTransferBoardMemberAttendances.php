...
class TeacherTransferBoardMemberAttendances extends Model
{
    use HasFactory, Blameable, LogsActivity;

    protected $table = 'teacher_transfer_board_member_attendances';
    ...
    */
    ...
    public function getActivitylogOptions(): LogOptions
    {
        return LogOptions::defaults()
            ->logAll()
            ->logOnlyDirty()
            ->useLogName('teacher_transfer_board_member_attendances')
            ->dontSubmitEmptyLogs();
    }
