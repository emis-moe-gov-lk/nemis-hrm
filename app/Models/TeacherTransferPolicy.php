...
class TeacherTransferPolicy extends Model
{
    use HasFactory, Blameable;

    protected $table = 'teacher_transfer_policies';
    ...
    */
    ...
    {
        return $this->hasMany(
            TeacherTransferPolicyStep::class,
            'policy_id',
            'policy_id'
        )->orderBy('step_order');
    }
    ...
    {
        return TeacherTransferCategory::scopedListQuery($this->policy_id);
    }

    public function scoreRules()
    {
        return $this->hasMany(
            TeacherTransferPolicyScoreRule::class,
            'policy_id',
            'policy_id'
        );
    }
    ...
    {
        return $this->hasMany(
            TeacherTransferPolicyFacilityScoreRule::class,
            'policy_id',
            'policy_id'
        );
    }
    ...
    {
        return $this->hasMany(
            TeacherTransferPolicyAchievementLevelScore::class,
            'policy_id',
            'policy_id'
        );
    }
