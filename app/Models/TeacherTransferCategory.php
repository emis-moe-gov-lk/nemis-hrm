...
class TeacherTransferCategory extends Model
{
    use HasFactory;

    protected $table = 'teacher_transfer_categories';
    ...
    protected static function booted()
    {
        static::creating(function ($model) {
            ...
            if (empty($model->transfer_category_id)) {
                $model->transfer_category_id = static::generateNextTeacherTransferCategoryId();
            }
        });
    }

    protected static function generateNextTeacherTransferCategoryId(): string
    {
        $lastId = static::query()
    ...
    */
    ...
    public function scopeForSubCategory($query, ?string $subCategoryId)
    {
        if ($subCategoryId) {
            $query->where('transfer_sub_category_id', $subCategoryId);
        }
