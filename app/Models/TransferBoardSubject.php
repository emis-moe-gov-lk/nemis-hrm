...
class TransferBoardSubject extends Model
{
    use HasFactory, Blameable, LogsActivity;

    protected $table = 'transfer_board_subjects';
    ...
    {
        return $this->belongsTo(TransferBoard::class, 'board_id', 'board_id');
    }
    ...
    public function getActivitylogOptions(): LogOptions
    {
        return LogOptions::defaults()
            ->logAll()
            ->logOnlyDirty()
            ->useLogName('transfer_board_subjects')
            ->dontSubmitEmptyLogs();
    }
}
