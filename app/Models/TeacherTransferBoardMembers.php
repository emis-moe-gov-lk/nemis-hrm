...
class TeacherTransferBoardMembers extends Model
{
    use HasFactory, Blameable, LogsActivity;

    protected $table = 'teacher_transfer_board_members';
    ...
    */
    ...
    {
        return $this->hasMany(
            TeacherTransferBoardMemberAttendances::class,
            'tbm_id',
            'tbm_id'
        );
    }
    ...
    */
    ...
    public function getActivitylogOptions(): LogOptions
    {
        return LogOptions::defaults()
            ->logAll()
            ->logOnlyDirty()
            ->useLogName('teacher_transfer_board_members')
            ->dontSubmitEmptyLogs();
    }
}
