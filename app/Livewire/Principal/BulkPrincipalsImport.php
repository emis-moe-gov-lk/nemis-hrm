...
class BulkPrincipalsImport extends Component
{
    use WithFileUploads;
    ...
    public function import()
    {
        ...
        try {
            ...
            if ($this->successCount > 0) {
                session()->flash('success', 'Principals imported successfully!');
            } else {
                session()->flash('error', 'No principals were imported. Please check your file.');
            }
            ...
            logger()->error('Principal import failed', ['error' => $e->getMessage()]);
            session()->flash('error', 'Import failed: ' . $e->getMessage());
        }

        return redirect()->route('principal.list');
    }

    public function render()
    {
        return view('livewire.principal.bulk-principals-import');
    }
}
