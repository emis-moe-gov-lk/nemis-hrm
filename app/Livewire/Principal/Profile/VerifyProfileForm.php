...
{
    public $peopleId; // Principal people_id
    public $people;
    public $password;
    ...
    public function submit()
    {
        ...
        if (!$appointment) {
            session()->flash('error', 'No active appointment found for this principal.');
            return;
        }
        ...
        //$this->redirect(route('principal.profile.index', $this->people->id), navigate: true);
        return $this->redirect(url()->previous(), navigate: true);
    }

    public function render()
    {
        return view('livewire.principal.profile.verify-profile-form');
    }
}
