...
class InstitutionProfileForTeacherTransferBoard extends Component
{
    public $application;
    public $institution;
    ...
    protected function canOpenNeedBasedInstitution(): bool
    {
        $board = $this->selectedBoardId !== ''
            ? TeacherTransferBoard::where('board_id', $this->selectedBoardId)->first(['bo_office_level_id', 'bo_workplace_id'])
            : null;
    ...
    {
        return view('livewire.transfer-module.teacher.teacher-transfer-board.institution-profile-for-transfer-board');
    }
}
