...
class NtionalTeacherTransferBoard extends Component
{
    use WithPagination;
    ...
    {
        return view('livewire.transfer-module.transfer-board.ntional-teacher-transfer-board', [
            'applications' => $this->applications,
            'stats' => $this->stats,
            'categories' => TransferCategory::active()->orderBy('transfer_category_name')->get(),
        ]);
    }
}
