...
class DOSList extends Component
{
    use WithPagination;
    ...
    public function updatedQuery()
    {
        ...
        // base query: restrict to development officer in allowed workplaces
        $peopleQuery = People::query()
            ->whereHas('currentAppointment', function ($q) use ($allowedWorkplaceIds) {
                $q->where('service_id', 'SER007')       // development officer service
    ...
    public function render()
    {
        ...
        // Main development officer query
