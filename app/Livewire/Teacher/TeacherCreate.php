...
class TeacherCreate extends Component
{
    ...
    public $zonalEducationOffice, $institutionCategory, $institution, $position;
    ...
    public $teacherTypeOptions = [], $zonalEducationOfficeOption = [], $positionOption = [], $currentPositionOption = [];
        ...
        switch ($this->step) {
            ...
            case 4:
                return [
                    ...
                    'secondaryTeachingSubject' => 'nullable|string',
    ...
    public function mount()
    {
        ...
        $this->servicesOption = Service::where('service_id', 'SER001')->active()->get();
        ...
        $this->appointmentSubjectOption = ApointedSubject::active()->orderBy('name_en', 'asc')->get();
        $this->appointmentMediumOptions = MediumOfInstruction::active()->get();
        //$this->positionOption = Position::active()->get();
    ...
    public function updatedNic($value)
    {
        ...
        //$this->myNewNic = NicHelper::toNewFormat($nic);
    ...
    public function searchNic()
    {
        ...
        // Extract birthday + gender
        $nic = NicHelper::normalize($nic);
    ...
    public function save()
    {
        ...
        try {
            ...
            $currentAppointmentLetterNo = $this->teacherRegType === 'new' ? $this->appointmentLetterNo : $this->currentAppointmentLetterNo;
            ...
            session()->flash('success', 'Teacher created successfully! Default password: ' . $password);
            $this->resetForm();
            $this->dispatch('scroll-top');
            ...
            DB::rollBack();
            session()->flash('error', 'Duplicate entry: Unable to save teacher data.');
            $this->dispatch('scroll-top');
        } catch (\Throwable $e) {
            DB::rollBack();
