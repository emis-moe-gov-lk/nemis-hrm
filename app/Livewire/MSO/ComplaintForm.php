...
class ComplaintForm extends Component
{
    public $subject;
    public $complaint;
    public $peopleId; // Management Assistant Officer people_id
    public $people;
    ...
    public function save()
    {
        ...
        $this->redirect(route('mso.profile.index', $this->people->id), navigate: true);
    }

    public function render()
    {
        return view('livewire.m-s-o.complaint-form');
    }
}
