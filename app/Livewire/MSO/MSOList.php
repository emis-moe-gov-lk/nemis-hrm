...
class MSOList extends Component
{
    ...
    public function updatedQuery()
    {
        ...
        // base query: restrict to management assistant in allowed workplaces
        $peopleQuery = People::query()
            ->whereHas('currentAppointment', function ($q) use ($allowedWorkplaceIds) {
                $q->where('service_id', 'SER008')       // management assistant service
    ...
    public function render()
    {
        ...
        // Main management assistant query
