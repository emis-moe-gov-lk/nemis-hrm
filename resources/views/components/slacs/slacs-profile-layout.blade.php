                ...
                <div class="flex-1 text-center md:text-left md:mb-4">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center gap-1 md:gap-3 mt-1">
                        <p class="text-indigo-600 dark:text-indigo-400 font-bold text-xs md:text-sm tracking-widest">
                            {{ $slacs->currentAppointment?->appointment?->service?->service_name ?? 'Service Not Assigned' }}
                        </p>
                        ...
                        <p class="text-slate-500 dark:text-slate-500 font-medium text-sm md:text-base flex items-center justify-center md:justify-start gap-1.5">
                            ...
                            {{ $slacs->currentAppointment?->workplace?->office_name ?? 'No Workplace Assigned' ?? 'No Workplace Assigned' }}
                        </p>
                    </div>
                </div>
