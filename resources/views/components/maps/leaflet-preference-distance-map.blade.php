    ...
    <div class="space-y-4">
        <div class="rounded-2xl border border-slate-200 bg-slate-50/70 p-4 dark:border-zinc-800 dark:bg-zinc-800/30">
            <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                ...
                <div class="rounded-2xl border border-slate-200 bg-white px-3 py-2 text-xs font-semibold text-slate-500 shadow-sm dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-300">
        ...
        <div wire:ignore x-ref="map" class="{{ $height }} w-full rounded-[1.5rem] border border-slate-200 dark:border-zinc-800 relative z-10 overflow-hidden shadow-sm"></div>
    </div>

    <div class="rounded-[1.5rem] border border-slate-200 bg-slate-50/60 p-4 dark:border-zinc-800 dark:bg-zinc-800/25">
        ...
        <div class="mt-4 space-y-3 max-h-[28rem] overflow-y-auto pr-1">
            <template x-for="school in schoolSummaries" :key="school.institution_workplace_id || school.order">
                <div class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm dark:border-zinc-700 dark:bg-zinc-900/80">
                    <div class="flex items-start justify-between gap-3">
                        ...
                        <div class="text-right">
                            <p class="text-[10px] font-bold uppercase tracking-[0.18em] text-slate-400 dark:text-zinc-500">{{ __('Km') }}</p>
