            ...
            <div class="antialiased min-h-screen">
                ...
                <div class="bg-white dark:bg-gray-800 p-2 rounded-b-lg">
                    ...
                    <div class="space-y-6">
                        ...
                        <livewire:employees.educational-qualification :peopleId="$mso->people_id" :canCreate="auth()->user()->can('mso.profile.qualification.create')" :canDelete="auth()->user()->can('mso.profile.qualification.delete')" />
