<div>
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('Bulk upload development officer') }}</flux:heading>
            ...
            <div class="max-w-5xl bg-white p-6 rounded-lg border border-gray-200">
                ...
                @if (session()->has('success'))
                    <div class="p-4 mb-4 text-green-700 bg-green-50 border border-green-200 rounded">
                        ...
                        @if ($successCount > 0)
                            <p class="text-sm mt-1">{{ $successCount }} development officer imported successfully.</p>
                        @endif
                    </div>
                @endif
                ...
                <div class="mb-6 p-4 bg-blue-50 border border-blue-200 rounded">
                    ...
                    <a href="{{ route('dos.download.template') }}"
                ...
                <form wire:submit.prevent="import">
                    ...
                    <div class="flex justify-end gap-3">
                        ...
                        <button type="submit" wire:loading.attr="disabled"
                            ...
                            <span wire:loading.remove>Import development officer</span>
