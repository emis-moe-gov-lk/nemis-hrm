            ...
            <div class="antialiased min-h-screen">
                ...
                <div class="bg-white dark:bg-gray-800 p-2 rounded-b-lg">
                    ...
                    <div class="space-y-6">
                        ...
                        <livewire:employees.educational-qualification :peopleId="$dos->people_id" :canCreate="auth()->user()->can('dos.profile.qualification.create')" :canDelete="auth()->user()->can('dos.profile.qualification.delete')"/>
