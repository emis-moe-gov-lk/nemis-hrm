<section class="w-full">
    <div class="relative mb-6 w-full">
        ...
        <flux:subheading size="lg" class="mb-6">
            {{ __('Teachers serving in institutions under your assigned group(s).') }}
        </flux:subheading>
                        ...
                        <tbody class="divide-y divide-slate-200 dark:divide-slate-800">
                            @forelse ($teachers as $teacher)
                                <tr>
                                    ...
                                    <td class="px-4 py-3 text-slate-500 dark:text-slate-400">{{ $teacher->position?->position_name ?? 'Teacher' }}</td>
