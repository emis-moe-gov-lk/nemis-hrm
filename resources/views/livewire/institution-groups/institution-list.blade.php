<section class="w-full">
    <div class="relative mb-6 w-full">
        ...
        <flux:subheading size="lg" class="mb-6">
            {{ __('Institutions in groups assigned to your user account.') }}
        </flux:subheading>
                        ...
                        <tbody class="divide-y divide-slate-200 dark:divide-slate-800">
                            @forelse ($institutions as $institution)
                                <tr>
                                    ...
                                    <td class="px-4 py-3 text-slate-500 dark:text-slate-400">{{ $institution->census_no ? str_pad($institution->census_no, 5, '0', STR_PAD_LEFT) : 'N/A' }}</td>
