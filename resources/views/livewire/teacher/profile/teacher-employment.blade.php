            ...
            <div class="antialiased min-h-screen">
                ...
                <div class="bg-white dark:bg-gray-800 p-2 rounded-b-lg">
                    ...
                    <div class="space-y-6">
                        ...
                        <livewire:employees.services-history :peopleId="$people->people_id" :canCreate="auth()->user()->can('teacher.profile.employment.services-history.create')" :canDelete="auth()->user()->can('teacher.profile.employment.services-history.delete')" />
