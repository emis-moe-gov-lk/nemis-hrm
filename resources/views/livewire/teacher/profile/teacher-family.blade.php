            ...
            <div class="antialiased min-h-screen">
                ...
                <div class="bg-white dark:bg-gray-800 p-2 rounded-b-lg">
                    ...
                    <div class="space-y-6">
                        ...
                        <livewire:employees.family-information :peopleId="$teacher->people_id" :canCreate="auth()->user()->can('teacher.profile.family.create')" :canDelete="auth()->user()->can('teacher.profile.family.delete')"/>
