<div class="px-6 py-10 lg:px-12 max-w-7xl mx-auto space-y-12 pb-20">
    ...
    <div class="space-y-4">
        <nav class="flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-indigo-500">
            ...
            <flux:icon.chevron-right variant="micro" class="h-3 w-3 text-slate-300" />
            <span class="text-slate-400">Guidelines</span>
        </nav>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <div class="lg:col-span-3 sticky top-10 space-y-8 hidden lg:block">
            <div class="space-y-3">
                <h3 class="text-[10px] font-extrabold uppercase tracking-widest text-slate-400">Policy Sections</h3>
                <nav class="flex flex-col space-y-1">
                    ...
                    <a href="#procedural" class="px-4 py-2 rounded-xl text-sm font-semibold text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-900 transition-colors">2. Procedural Logic</a>
                    <a href="#scoring" class="px-4 py-2 rounded-xl text-sm font-semibold text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-900 transition-colors">3. Scoring Matrix</a>
                    <a href="#documents" class="px-4 py-2 rounded-xl text-sm font-semibold text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-900 transition-colors">4. Required Documents</a>
                </nav>
            </div>
        ...
        <div class="lg:col-span-9 space-y-16">
            ...
            <section id="eligibility" class="space-y-6">
                ...
                <div class="bg-white dark:bg-slate-950 border border-slate-100 dark:border-slate-800/80 rounded-4xl p-8 shadow-sm space-y-8">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div class="space-y-3">
                            <h4 class="text-sm font-extrabold uppercase tracking-widest text-slate-400">Service Tenure</h4>
                        ...
                        <div class="space-y-3">
                            <h4 class="text-sm font-extrabold uppercase tracking-widest text-slate-400">Subject Specialization</h4>
                            <p class="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
            ...
            <section id="procedural" class="space-y-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex gap-6 p-6 bg-white dark:bg-slate-900/50 border border-slate-100 dark:border-slate-800 rounded-3xl group hover:border-indigo-100 transition-colors">
            ...
            <section id="documents" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="p-8 bg-white dark:bg-slate-950 border border-slate-100 dark:border-slate-800 rounded-4xl space-y-4">
