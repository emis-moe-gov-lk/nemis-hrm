<div class="space-y-6 pb-12">
    {{-- Header Section --}}
    <div class="bg-white dark:bg-zinc-900 rounded-xl p-8 border border-zinc-200 dark:border-zinc-800 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div class="flex items-center gap-3">
            ...
            <flux:button href="{{ route('my-transfer.teacher-annual-transfer') }}" variant="ghost" icon="chevron-left" class="h-10 px-4 font-semibold">
                {{ __('Back to List') }}
            </flux:button>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-6">
            {{-- Applicant Summary --}}
            <section class="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-sm">
                <div class="px-6 py-4 border-b border-zinc-200 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-800/50 flex items-center gap-3">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-1">
                        <p class="text-xs font-semibold text-zinc-500 uppercase tracking-tight">{{ __('Full Name') }}</p>
                        <a href="{{ route('my-profile.index') }}" target="_blank" class="text-base font-semibold text-indigo-600 dark:text-indigo-400 hover:underline flex items-center gap-1.5">
                            {{ ($application->employee->title->title_name ?? '') . ' ' . $application->employee->full_name }}
                            <flux:icon name="arrow-top-right-on-square" variant="mini" class="h-3 w-3" />
                        </a>
                    </div>
                    <div class="space-y-1">
                        <p class="text-xs font-semibold text-zinc-500 uppercase tracking-tight">{{ __('NIC / Employee ID') }}</p>
                    ...
                    <div class="space-y-1">
                        <p class="text-xs font-semibold text-zinc-500 uppercase tracking-tight">{{ __('Gender') }}</p>
            ...
            <section class="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-sm">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-1">
                        <p class="text-xs font-semibold text-zinc-500 uppercase tracking-tight">{{ __('Teacher Category') }}</p>
                        <p class="text-base font-medium text-zinc-900 dark:text-zinc-100">{{ $teacher->teacherCategory->name ?? 'N/A' }}</p>
                    </div>
                    <div class="space-y-1">
                        <p class="text-xs font-semibold text-zinc-500 uppercase tracking-tight">{{ __('Appointment Subject') }}</p>
                        <p class="text-base font-medium text-zinc-900 dark:text-zinc-100">{{ $teacher->appointmentSubject->name_en ?? 'N/A' }}</p>
                    </div>
                    <div class="space-y-1">
                        <p class="text-xs font-semibold text-zinc-500 uppercase tracking-tight">{{ __('Medium') }}</p>
                        <p class="text-base font-medium text-zinc-900 dark:text-zinc-100">{{ $teacher->medium->name ?? 'N/A' }}</p>
                    </div>
                    <div class="space-y-1">
                        <p class="text-xs font-semibold text-zinc-500 uppercase tracking-tight">{{ __('Current Teaching Subject') }}</p>
            ...
            <section class="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-sm">
                ...
                <div class="p-6 space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-1">
                            <p class="text-xs font-semibold text-zinc-500 uppercase tracking-tight">{{ __('Policy Type') }}</p>
                            <p class="text-base font-medium text-zinc-900 dark:text-zinc-100">{{ $application->policy->title ?? 'N/A' }}</p>
                        </div>
                        <div class="space-y-1">
                            <p class="text-xs font-semibold text-zinc-500 uppercase tracking-tight">{{ __('Category') }}</p>
                            <p class="text-base font-medium text-zinc-900 dark:text-zinc-100">{{ $application->category->transfer_category_name ?? 'N/A' }}</p>
                        </div>
                        <div class="space-y-1">
                            <p class="text-xs font-semibold text-zinc-500 uppercase tracking-tight">{{ __('Target Province') }}</p>
                            <p class="text-base font-medium text-zinc-900 dark:text-zinc-100">{{ $application->targetProvince->name ?? 'N/A' }}</p>
                        </div>
                        <div class="space-y-1">
                            <p class="text-xs font-semibold text-zinc-500 uppercase tracking-tight">{{ __('Reason for Transfer') }}</p>
                    ...
                    <div class="p-5 bg-zinc-50 dark:bg-zinc-800/50 rounded-lg border border-zinc-200 dark:border-zinc-700">
                        <p class="text-xs font-semibold text-zinc-500 uppercase tracking-tight mb-2">{{ __('Detailed Statement') }}</p>
            ...
            {{-- Station Preferences --}}
            <section class="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-sm overflow-hidden">
                <div class="px-6 py-4 border-b border-zinc-200 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-800/50 flex items-center gap-3">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="bg-zinc-50/30 dark:bg-zinc-800/30 text-[10px] font-bold uppercase tracking-widest text-zinc-500 border-b border-zinc-200 dark:border-zinc-800">
                            ...
                            <tr class="hover:bg-zinc-50/50 dark:hover:bg-zinc-800/40 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <div class="space-y-1">
                                        ...
                                        <a href="{{ route('institutions.basic.view', $pref->institution->office()->id) }}" target="_blank" class="text-sm font-bold text-indigo-600 dark:text-indigo-400 hover:underline">
                                ...
                                <td class="px-6 py-4 text-center text-xs font-semibold text-zinc-500">
                                    {{ __('Calculating...') }}
                                </td>
                            </tr>
                            @endforeach
                        ...
                        <div class="space-y-10">
                            ...
                            <div class="relative pl-12">
                                ...
                                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                                    <div>
                                        ...
                                        <p class="text-xs text-zinc-500 dark:text-zinc-400 mt-1">{{ __('Initial Dossier received and workflow initiated.') }}</p>
                                    </div>
                            ...
                            $isFuture = $application->current_step < $step->step_order;
                                ...
                                <div class="relative pl-12 font-medium">
                                    {{-- Status Dot/Icon --}}
                                    <div @class([ 'absolute left-0 w-10 h-10 rounded-full border-2 flex items-center justify-center z-10 bg-white dark:bg-zinc-900' , 'border-emerald-500 shadow-sm shadow-emerald-500/10'=> $rec && !Str::contains(strtolower($rec->recommendation?->decision ?? ''), 'reject'),
                                        'border-rose-500 shadow-sm shadow-rose-500/10' => $rec && Str::contains(strtolower($rec->recommendation?->decision ?? ''), 'reject'),
                                        ...
                                        @if($rec)
                                        <flux:icon :name="Str::contains(strtolower($rec->recommendation?->decision ?? ''), 'reject') ? 'x-mark' : 'check'" class="h-5 w-5 {{ Str::contains(strtolower($rec->recommendation?->decision ?? ''), 'reject') ? 'text-rose-500' : 'text-emerald-500' }}" />
                                        @elseif($isCurrent)
                                    ...
                                    <div class="flex flex-col gap-4">
                                        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                                            <div>
                                                ...
                                                @if($rec)
                                                <p class="text-xs text-zinc-500 dark:text-zinc-400 mt-0.5">{{ $rec->workplace->office_name ?? '' }}</p>
                                                @endif
                                            </div>
                                            <div class="flex items-center gap-2">
                                                @if($rec)
                                                <flux:badge :color="Str::contains(strtolower($rec->recommendation?->decision ?? ''), 'reject') ? 'rose' : 'emerald'" size="sm" class="font-bold uppercase tracking-tight">
                                        ...
                                        <div class="p-4 bg-zinc-50 dark:bg-zinc-800/30 rounded-lg border border-zinc-200 dark:border-zinc-700 relative">
                                            ...
                                            <div class="mt-3 flex items-center gap-2 text-[11px] font-bold text-zinc-500 uppercase">
            ...
            @endphp
            <section class="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-sm overflow-hidden border-t-4 border-t-indigo-600">
                <div class="px-6 py-4 border-b border-zinc-200 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-800/50 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div class="flex items-center gap-3">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                        ...
                        <div class="lg:col-span-4 space-y-4">
                            <div class="bg-zinc-50 dark:bg-zinc-800/50 rounded-lg p-5 border border-zinc-200 dark:border-zinc-700">
                                <p class="text-[10px] uppercase font-bold text-zinc-500 mb-1">{{ __('Presiding Authority') }}</p>
                                ...
                                <div class="mt-4 pt-4 border-t border-zinc-200 dark:border-zinc-700">
                                    <p class="text-[10px] uppercase font-bold text-zinc-500 mb-1">{{ __('Transfer Category') }}</p>
                                    <p class="text-xs font-medium text-zinc-700 dark:text-zinc-300">{{ $application->category->transfer_category_name ?? __('N/A') }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        @if($boardDecision)
                        <div class="space-y-6">
                            <div class="p-6 bg-white dark:bg-zinc-800/20 rounded-lg border border-zinc-200 dark:border-zinc-800 shadow-sm relative">
                                ...
                                <div class="mt-5 grid grid-cols-1 gap-4 md:grid-cols-3">
                                    <div class="rounded-lg border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-700 dark:bg-zinc-900/40">
                                        <p class="text-[10px] uppercase font-bold text-zinc-500 mb-1">{{ __('School Selection') }}</p>
                                    ...
                                    <div class="rounded-lg border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-700 dark:bg-zinc-900/40">
                                        <p class="text-[10px] uppercase font-bold text-zinc-500 mb-1">{{ __('Selected Zone') }}</p>
                                        <p class="text-sm font-bold text-zinc-900 dark:text-white">{{ $boardDecision->selectedZone?->name ?? __('N/A') }}</p>
                                    </div>
                                    <div class="rounded-lg border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-700 dark:bg-zinc-900/40">
                                        <p class="text-[10px] uppercase font-bold text-zinc-500 mb-1">{{ __('Selected School') }}</p>
                                        <p class="text-sm font-bold text-zinc-900 dark:text-white">{{ $boardDecision->selectedSchool?->name ?? __('N/A') }}</p>
                                        <p class="mt-2 text-[10px] uppercase font-bold text-zinc-500">{{ __('Effective Date') }}: {{ $boardDecision->transfer_effective_date?->format('M d, Y') ?? __('N/A') }}</p>
                                    </div>
                                </div>
                            ...
                            <div class="h-full flex flex-col items-center justify-center py-12 px-6 bg-amber-50 dark:bg-amber-500/5 rounded-lg border border-dashed border-amber-200 dark:border-amber-500/20">
                                ...
                                <p class="text-xs text-zinc-500 dark:text-zinc-400 text-center max-w-sm">
                                    {{ __('The Transfer Board is currently reviewing the final recommendation. Results will be updated shortly.') }}
                                </p>
                            </div>
                            @else
                            <div class="h-full flex flex-col items-center justify-center py-12 px-6 bg-zinc-50 dark:bg-zinc-800/10 rounded-lg border border-dashed border-zinc-200 dark:border-zinc-800">
        ...
        <div class="space-y-6">
            ...
            <section class="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-sm overflow-hidden">
                ...
                <div class="p-6 space-y-6">
                    <div class="space-y-1">
                        <p class="text-xs font-semibold text-zinc-500 uppercase">{{ __('First Appointment') }}</p>
                    ...
                    <div class="space-y-1">
                        <p class="text-xs font-semibold text-zinc-500 uppercase">{{ __('Current Station Entry') }}</p>
                    ...
                    <div class="pt-4 border-t border-zinc-100 dark:border-zinc-800/60">
                        <p class="text-xs font-semibold text-zinc-500 uppercase mb-1">{{ __('Active School') }}</p>
            ...
            @endphp
            <section class="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-sm overflow-hidden border-t-4 border-t-amber-500">
                <div class="px-6 py-4 border-b border-zinc-200 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-800/50 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div class="flex items-center gap-3">
                ...
                <div class="p-6 space-y-5">
                    @if(!$boardDecision)
                        <div class="rounded-2xl border border-dashed border-zinc-200 bg-zinc-50/80 px-5 py-4 text-sm text-zinc-500 dark:border-zinc-800 dark:bg-zinc-800/30 dark:text-zinc-400">
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-3">
                        @forelse($appeals as $appeal)
                            ...
                            @endphp
                            <div class="rounded-2xl border border-zinc-200 bg-zinc-50/70 p-5 dark:border-zinc-800 dark:bg-zinc-800/30">
                                <div class="flex items-center justify-between gap-3">
                                    <div>
                                        <p class="text-sm font-bold text-zinc-900 dark:text-white">{{ $appeal->appeal_id }}</p>
                                        <p class="mt-1 text-xs text-zinc-500 dark:text-zinc-400">{{ __('Appeal #:number', ['number' => $appeal->number_of_appeals]) }}</p>
                                    </div>
                                    <flux:badge :color="$appealBadge['color']" size="sm" class="uppercase tracking-tighter">{{ $appealBadge['label'] }}</flux:badge>
                                </div>

                                <div class="mt-4 space-y-3 text-sm text-zinc-700 dark:text-zinc-300">
                                    <div>
                                        <p class="text-[11px] font-bold uppercase tracking-[0.22em] text-zinc-500 dark:text-zinc-400">{{ __('Appeal Reason') }}</p>
                                        <p class="mt-1">{{ $appeal->appeal_reason }}</p>
                                    </div>

                                    @if($appeal->appeal_remarks)
                                        <div>
                                            <p class="text-[11px] font-bold uppercase tracking-[0.22em] text-zinc-500 dark:text-zinc-400">{{ __('Teacher Remarks') }}</p>
                                            <p class="mt-1">{{ $appeal->appeal_remarks }}</p>
                                        </div>
                                    @endif

                                    @if($appeal->decision_remarks)
                                        <div>
                                            <p class="text-[11px] font-bold uppercase tracking-[0.22em] text-zinc-500 dark:text-zinc-400">{{ __('Appeal Board Note') }}</p>
                                            <p class="mt-1">{{ $appeal->decision_remarks }}</p>
                                        </div>
                                    @endif
                        ...
                        @empty
                            <div class="rounded-2xl border border-dashed border-zinc-200 bg-zinc-50/70 px-5 py-4 text-sm text-zinc-500 dark:border-zinc-800 dark:bg-zinc-800/30 dark:text-zinc-400 md:col-span-2 xl:col-span-3">
            ...
            <section class="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-sm overflow-hidden border-l-4 border-l-emerald-500">
                <div class="p-6">
    ...
    <flux:modal wire:model="showAppealModal" name="teacher-transfer-appeal" class="w-full max-w-3xl rounded-[2rem] border border-zinc-200/70 dark:border-zinc-800">
        <div class="space-y-6">
            <div class="space-y-2">
