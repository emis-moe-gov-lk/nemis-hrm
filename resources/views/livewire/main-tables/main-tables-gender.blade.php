            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-6">
                    ...
                    <div class="relative group bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-[2.5rem] p-6 shadow-sm hover:shadow-xl hover:border-indigo-300 dark:hover:border-indigo-800 transition-all duration-300">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="flex items-center gap-2 mt-1">
                                <span class="text-[10px] font-bold text-slate-500 uppercase tracking-tighter italic">Unique ID:</span>
                                <span class="text-[11px] font-mono font-bold text-slate-600 dark:text-slate-500">{{ $data->gender_id }}</span>
                            </div>
                        </div>
                ...
                @empty
                    <div class="col-span-full py-24 text-center">
                        ...
                        <h3 class="text-lg font-black text-slate-500 uppercase tracking-widest">{{ __('No Gender Records Found') }}</h3>
                    </div>
                @endforelse
            </div>
