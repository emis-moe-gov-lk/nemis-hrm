            ...
            <div class="antialiased min-h-screen">
                ...
                <div class="bg-white dark:bg-gray-800 p-2 rounded-b-lg">
                    ...
                    <div class="space-y-6">
                        ...
                        <livewire:employees.working-place-history :peopleId="$people->people_id" :canCreate="auth()->user()->can('principal.profile.employment.working-place-history.create')" :canDelete="auth()->user()->can('principal.profile.employment.working-place-history.delete')" />

                        {{-- 5. Position History --}}
                        <livewire:employees.position-history :peopleId="$people->people_id" :canCreate="auth()->user()->can('principal.profile.employment.position-history.create')" :canDelete="auth()->user()->can('principal.profile.employment.position-history.delete')" />
