            ...
            <div class="antialiased min-h-screen">
                ...
                <div class="bg-white dark:bg-gray-800 p-2 rounded-b-lg">
                    ...
                    <div class="space-y-6">
                        ...
                        <livewire:employees.educational-qualification :peopleId="$principal->people_id" :canCreate="auth()->user()->can('principal.profile.qualification.create')" :canDelete="auth()->user()->can('principal.profile.qualification.delete')" />

                        {{-- 2. Audit Data (NIC Hash) --}}
