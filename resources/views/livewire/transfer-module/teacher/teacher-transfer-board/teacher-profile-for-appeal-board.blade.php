<div class="p-6 lg:p-8 space-y-8">
    ...
    <div class="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
        ...
        <div class="flex flex-wrap items-center gap-2">
            ...
            @elseif($this->isReadOnlyObserver)
                <flux:button icon="eye" size="sm" disabled>{{ __('Read Only') }}</flux:button>
            @else
    ...
    @if($this->isReadOnlyObserver)
        <div class="rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm font-medium text-amber-900 dark:border-amber-900/60 dark:bg-amber-950/30 dark:text-amber-200">
            {{ __('This zonal appeal board is being viewed from the provincial level in read-only mode. You can review the appeal and original decision history, but you cannot make or edit the appeal-board decision from here.') }}
        </div>
    @endif

    <div class="grid grid-cols-1 gap-6 xl:grid-cols-3">
        <div class="rounded-3xl border border-slate-300 bg-white p-6 shadow-sm dark:border-zinc-700 dark:bg-zinc-900 xl:col-span-1">
        ...
        <div class="rounded-3xl border border-slate-300 bg-white p-6 shadow-sm dark:border-zinc-700 dark:bg-zinc-900 xl:col-span-2">
            ...
            <div class="mt-6 rounded-2xl border border-slate-300 bg-slate-50/70 p-5 text-sm leading-6 text-slate-700 dark:border-zinc-700 dark:bg-zinc-800/30 dark:text-zinc-300">
        ...
        <div class="rounded-3xl border border-slate-300 bg-white p-6 shadow-sm dark:border-zinc-700 dark:bg-zinc-900 xl:col-span-2">
            ...
            <div class="mt-5 grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm font-semibold text-slate-900 dark:text-zinc-100">{{ $application->display_category_name }}</p>
                </div>
                <div>
        ...
        <div class="rounded-3xl border border-slate-300 bg-white p-6 shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <div class="mt-5 space-y-4 text-sm text-slate-700 dark:text-zinc-300">
                ...
                <div>
                    ...
                    <p class="mt-1 font-semibold">{{ $this->selectedAppealBoard?->display_category_name ?? __('N/A') }}</p>
                </div>
                <div>
    ...
    <div class="rounded-3xl border border-slate-300 bg-white shadow-sm dark:border-zinc-700 dark:bg-zinc-900 overflow-hidden">
    ...
    <flux:modal wire:model="showDecisionModal" name="appeal-decision-modal" class="w-full max-w-4xl rounded-4xl border border-slate-300/70 dark:border-zinc-700">
        <div class="space-y-6">
            <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                <div class="max-w-2xl">
