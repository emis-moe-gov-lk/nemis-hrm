        ...
        <div class="xl:col-span-4 space-y-8">
            <div class="bg-white dark:bg-zinc-900 rounded-3xl border border-slate-200 dark:border-zinc-800 shadow-sm overflow-hidden">
                ...
                <div class="p-6 space-y-5">
                    <div>
                        <p class="text-[11px] font-bold uppercase tracking-wider text-slate-400 dark:text-zinc-500">{{ __('Census / Workplace') }}</p>
                    ...
                    <div>
                        <p class="text-[11px] font-bold uppercase tracking-wider text-slate-400 dark:text-zinc-500">{{ __('Category') }}</p>
                    ...
                    <div>
                        <p class="text-[11px] font-bold uppercase tracking-wider text-slate-400 dark:text-zinc-500">{{ __('Type / Grade Span') }}</p>
                    ...
                    <div>
                        <p class="text-[11px] font-bold uppercase tracking-wider text-slate-400 dark:text-zinc-500">{{ __('Language / Gender') }}</p>
                    ...
                    <div>
                        <p class="text-[11px] font-bold uppercase tracking-wider text-slate-400 dark:text-zinc-500">{{ __('Zonal / Divisional') }}</p>
                    ...
                    <div>
                        <p class="text-[11px] font-bold uppercase tracking-wider text-slate-400 dark:text-zinc-500">{{ __('Contact') }}</p>
                    ...
                    <div class="pt-4 border-t border-slate-200 dark:border-zinc-800">
                        <p class="text-[11px] font-bold uppercase tracking-wider text-slate-400 dark:text-zinc-500">{{ __('Address') }}</p>
            ...
            <div class="bg-white dark:bg-zinc-900 rounded-3xl border border-slate-200 dark:border-zinc-800 shadow-sm overflow-hidden">
                ...
                <div class="p-6 space-y-4">
                    <div class="grid grid-cols-2 gap-4">
                        <div class="rounded-2xl border border-slate-200 dark:border-zinc-800 bg-slate-50/50 dark:bg-zinc-800/20 p-4">
                    ...
                    @if($activeCircular)
                        <div class="rounded-2xl border border-slate-200 dark:border-zinc-800 bg-slate-50/50 dark:bg-zinc-800/20 p-4">
                            <p class="text-[10px] font-bold uppercase tracking-wider text-slate-400 dark:text-zinc-500">{{ __('Active Circular') }}</p>
                    ...
                    @else
                        <div class="rounded-2xl border border-dashed border-slate-200 dark:border-zinc-800 p-4 text-sm text-slate-500 dark:text-zinc-400">
                            ...
                            @forelse($staffRows as $staff)
                                ...
                                <tr class="hover:bg-slate-50/50 dark:hover:bg-zinc-800/20 transition-all duration-200">
                                    <td class="px-6 py-4 align-top">
                                        ...
                                        @if($staff['rank_label'])
                                            <p class="mt-1 text-xs text-slate-400 dark:text-zinc-500">{{ $staff['rank_label'] }}</p>
                                        @endif
                                    </td>
                                    <td class="px-6 py-4 align-top">
                                    ...
                                    <td class="px-6 py-4 align-top">
                                        ...
                                        @if($staff['medium'])
                                            <p class="mt-1 text-xs text-slate-400 dark:text-zinc-500">{{ $staff['medium'] }}</p>
                                        @endif
                                    </td>
                                    <td class="px-6 py-4 align-top">
                                    ...
                                    <td class="px-6 py-4 align-top">
                                        ...
                                        @else
                                            <span class="text-sm text-slate-400 dark:text-zinc-500">{{ __('No active transfer request') }}</span>
                                        @endif
                                    </td>
                                </tr>
                            @empty
