    ...
    <header class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-3">
            <div class="text-right hidden sm:block">
                <p class="text-[10px] font-bold uppercase text-slate-400 tracking-widest">Total Schools</p>
            ...
            <div class="group bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-[2rem] p-2 pr-6 transition-all duration-300 hover:shadow-xl hover:shadow-indigo-500/5 hover:border-indigo-500/30">
                <div class="flex flex-col lg:flex-row lg:items-center gap-6">
                    ...
                    <div class="flex items-center gap-2 pl-4 lg:pl-0">
                        @can('office.institution.profile.overview.view')
                            <flux:button href="{{ route('institutions.profile.overview', $institution->id) }}" variant="filled" size="sm" class="rounded-xl">
                                View
                            </flux:button>
                        @endcan
                        ...
                        <flux:dropdown>
                            ...
                            <flux:menu>
                                ...
                                @endcan
                                <flux:menu.item icon="user-group">Student Population</flux:menu.item>
                                <flux:menu.separator />
