<section class="w-full">
    ...
    <div class="relative mb-8 w-full">
        <flux:heading size="xl" level="1" class="mb-1">{{ __('Institution Cadre Summary for MOE') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('List of Cadre Summary under the selected MOE.') }}</flux:subheading>
