    ...
    <x-offices.moe.layout :officeId="$officeId">
        ...
        <header class="mb-10">
            ...
            <flux:subheading size="lg" class="text-slate-500 dark:text-slate-500 font-medium max-w-2xl mb-6">
                {{ __('Manage and view the list of staff members, their roles, and professional history within this Ministry office.') }}
            </flux:subheading>
        </header>
        ...
        <div class="mt-8 space-y-8">
                    ...
                    <tbody class="divide-y divide-slate-50 dark:divide-slate-800/50">
                        ...
                        <tr class="hover:bg-indigo-50/30 dark:hover:bg-indigo-500/5 transition-all group">
                                ...
                                <div class="flex items-center gap-3">
                                    <div>
                                        ...
                                        <div class="text-[10px] font-mono text-slate-500 dark:text-slate-500 mt-1 uppercase tracking-widest">
                                            {{ $staff->employee->nic ?? $staff->employee_id }}
                                        </div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-5 text-right">
                                @php
                                $serviceId = $staff->appointment?->service_id ?? clone $staff->service_id;
            ...
            <div class="py-24 flex flex-col items-center justify-center bg-slate-50 dark:bg-slate-900/50 rounded-[3rem] border-2 border-dashed border-slate-300 dark:border-slate-700">
                ...
                <p class="mt-2 text-sm text-slate-500 dark:text-slate-500 max-w-xs text-center font-medium">
                    {{ __('No staff members are currently assigned to this Ministry office.') }}
                </p>
            </div>
            @endif
        </div>
