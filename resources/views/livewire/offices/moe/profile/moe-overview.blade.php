    ...
    <x-offices.moe.layout :officeId="$officeId">
        ...
        <header class="mb-10">
            <flux:heading size="xl" level="1">
                {{ __('Ministry of Education Overview') }}
            </flux:heading>
            <flux:subheading size="lg" class="text-slate-500 dark:text-slate-500 font-medium max-w-2xl mb-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="relative overflow-hidden bg-white dark:bg-[#151518] border border-slate-300 dark:border-slate-700/60 rounded-[1.25rem] p-6 shadow-sm group hover:border-blue-500/30 transition-all">
                ...
                <div class="relative z-10 flex flex-col justify-center h-full">
                    <div class="text-[10px] font-bold text-slate-500 dark:text-slate-500 uppercase tracking-widest mb-1">{{ __('Total Students') }}</div>
                    <div class="text-4xl font-black text-slate-900 dark:text-white tracking-tighter">{{ number_format($studentCount) }}</div>
                    <div class="text-[10px] font-bold text-slate-500 dark:text-slate-500 uppercase tracking-tight mt-1">{{ __('Total Students Nationwide') }}</div>
                </div>
            </div>

            {{-- Ministries Card --}}
            <div class="relative overflow-hidden bg-white dark:bg-[#151518] border border-slate-300 dark:border-slate-700/60 rounded-[1.25rem] p-6 shadow-sm group hover:border-purple-500/30 transition-all">
                ...
                <div class="relative z-10 flex flex-col justify-center h-full">
                    <div class="text-[10px] font-bold text-slate-500 dark:text-slate-500 uppercase tracking-widest mb-1">{{ __('Provincial Ministries') }}</div>
                    <div class="text-4xl font-black text-slate-900 dark:text-white tracking-tighter">{{ $provincialMinistryCount }}</div>
                    <div class="text-[10px] font-bold text-slate-500 dark:text-slate-500 uppercase tracking-tight mt-1">{{ __('Ministry Offices Count') }}</div>
                </div>
            </div>
            ...
            <div class="relative overflow-hidden bg-white dark:bg-[#151518] border border-slate-300 dark:border-slate-700/60 rounded-[1.25rem] p-6 shadow-sm group hover:border-emerald-500/30 transition-all">
                ...
                <div class="relative z-10 flex flex-col justify-center h-full">
                    ...
                    <div class="text-[10px] font-bold text-slate-500 dark:text-slate-500 uppercase tracking-tight mt-1">{{ __('Education Departments') }}</div>
                </div>
            </div>
            ...
            <div class="relative overflow-hidden bg-white dark:bg-[#151518] border border-slate-300 dark:border-slate-700/60 rounded-[1.25rem] p-6 shadow-sm group hover:border-amber-500/30 transition-all">
                ...
                <div class="relative z-10 flex flex-col justify-center h-full">
                    ...
                    <div class="text-[10px] font-bold text-slate-500 dark:text-slate-500 uppercase tracking-tight mt-1">{{ __('Zonal Education Offices') }}</div>
                </div>
            </div>
