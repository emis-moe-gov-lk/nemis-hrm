    ...
    <x-offices.moe.layout :officeId="$officeId">
        ...
        <header class="mb-10">
            <flux:heading size="xl" level="1">
                {{ __('Ministry of Education Profile') }}
            </flux:heading>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div class="p-2 bg-gray-50 dark:bg-gray-700 rounded-md border border-gray-200 dark:border-gray-600">
                                    ...
                                    <p class="text-sm font-medium text-gray-900 dark:text-gray-100">
                                        {{ $EducationMinistry->workplace_id ?? 'N/A' }}
                                    </p>
                                </div>
                            </div>
                        </section>
                        ...
                        <section>
                            <div class="mb-3">
                                <div class="flex items-baseline justify-between py-2">
                                    ...
                                    <flux:modal.trigger name="edit-moe-contact">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div class="p-2 bg-gray-50 dark:bg-gray-700 rounded-md border border-gray-200 dark:border-gray-600">
                                    ...
                                    <p class="text-sm font-medium text-blue-600 dark:text-blue-400">
                                        <a href="mailto:{{ $EducationMinistry->email }}">{{ $EducationMinistry->email ?? 'N/A' }}</a>
                                    </p>
                                </div>
                                <div class="p-2 bg-gray-50 dark:bg-gray-700 rounded-md border border-gray-200 dark:border-gray-600">
                                    <p class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Phone</p>
                                    <p class="text-sm font-medium text-blue-600 dark:text-blue-400">
                                        <a href="tel:{{ $EducationMinistry->phone }}">{{ $EducationMinistry->phone ?? 'N/A' }}</a>
                                    </p>
                                </div>
                            </div>
                        </section>
                        ...
                        <section>
                            <div class="mb-3">
                                <div class="flex items-baseline justify-between py-2">
                                    ...
                                    <flux:modal.trigger name="edit-moe-location">
                                        <flux:button>Edit</flux:button>
                                    </flux:modal.trigger>
                                </div>
                                <flux:separator variant="subtle" />
                        ...
                        <section>
                            <div class="mb-3">
                                <div class="flex items-baseline justify-between py-2">
                                    ...
                                    <flux:modal.trigger name="edit-moe-mission-vision">
                                        <flux:button>Edit</flux:button>
                                    </flux:modal.trigger>
                                </div>
                                <flux:separator variant="subtle" />
                    ...
                    <div class="pt-8 mt-12 border-t border-slate-200 dark:border-slate-700 flex flex-col md:flex-row justify-between items-center gap-4">
                        <div class="flex items-center gap-3 px-4 py-2 bg-slate-50 dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700">
                            ...
                            <span class="text-[10px] font-mono text-slate-500 dark:text-slate-500 uppercase tracking-widest">
                                {{ __('System Key:') }} <span class="text-indigo-600 dark:text-indigo-400 font-bold">{{ $EducationMinistry->id }}</span>
                            </span>
                        </div>
        ...
        <flux:modal name="edit-moe-contact" class="md:w-130">
            <div class="space-y-6">
                <div>
        ...
        {{-- ── Edit Location Modal ──────────────────────────────────────── --}}
        <flux:modal name="edit-moe-location" class="md:w-130">
            <div class="space-y-6">
                <div>
        ...
        <flux:modal name="edit-moe-mission-vision" class="md:w-130">
            <div class="space-y-6">
                <div>
