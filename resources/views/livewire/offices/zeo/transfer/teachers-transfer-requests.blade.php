                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-slate-700">
                    ...
                    <tbody class="bg-white dark:bg-slate-800 divide-y divide-gray-200 dark:divide-slate-700">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors duration-200 group">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap border-r border-gray-200 dark:border-slate-700 last:border-r-0 text-sm">
                                <div class="flex flex-col">
                                    <span class="font-semibold text-slate-900 dark:text-white">
                                        {{ $request->currentWorkplace->office_name ?? 'N/A' }}
                                    </span>
                                    <span class="text-[10px] uppercase font-bold text-slate-400 tracking-wider">
                                        {{ $request->currentWorkplace->workplace_id ?? '' }}
                                    </span>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-right border-r border-gray-200 dark:border-slate-700 last:border-r-0">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <flux:button size="sm" variant="ghost" icon="eye" wire:navigate href="{{ route('transfer.teacher-transfer-application.view', $request->transfer_application_id) }}" title="View Application Details" />
                                </div>
                            </td>
                        </tr>
                        @empty
                        <tr>
                            <td colspan="6" class="px-6 py-20 text-center">
                                <div class="flex flex-col items-center justify-center space-y-3">
                                    ...
                                    <h4 class="text-sm font-bold text-slate-900 dark:text-white">{{ __('No Zonal Requests Found') }}</h4>
