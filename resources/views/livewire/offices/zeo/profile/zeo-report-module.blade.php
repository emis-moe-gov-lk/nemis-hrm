<section class="w-full">
    <x-offices.zeo.zeo-layout :officeId="$officeId">
        ...
        <div class="overflow-x-auto bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-3xl shadow-sm mt-6 hidden md:block">
            <table class="w-full text-left border-collapse">
                <thead class="bg-slate-50/80 dark:bg-slate-800/50 border-b border-slate-300 dark:border-slate-700">
                    <tr>
                        <th class="px-6 py-5 text-[11px] font-black uppercase tracking-widest text-slate-500 dark:text-slate-500 border-r border-slate-200 dark:border-slate-700/50">ID</th>
                        <th class="px-6 py-5 text-[11px] font-black uppercase tracking-widest text-slate-500 dark:text-slate-500">Description</th>
                        <th class="px-6 py-5 text-[11px] font-black uppercase tracking-widest text-slate-500 dark:text-slate-500 text-right">Actions</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-slate-100 dark:divide-slate-800/60">
                    <tr class="hover:bg-slate-50/50 dark:hover:bg-indigo-700/30 transition-colors group">
                        <td class="px-6 py-4 border-r border-slate-200 dark:border-slate-700/50 text-sm font-bold text-slate-600 dark:text-slate-500">1</td>
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex item-center justify-end gap-3">
                                <button class="transform text-slate-500 hover:text-blue-600 dark:text-slate-500 dark:hover:text-blue-400 transition-colors hover:scale-110">
                                ...
                                <a href="{{route('pdf.zeo-institution-list', $officeId)}}" target="_blank" class="transform text-slate-500 hover:text-red-500 dark:text-slate-500 dark:hover:text-red-400 transition-colors hover:scale-110">
                    ...
                    <tr class="hover:bg-slate-50/50 dark:hover:bg-indigo-700/30 transition-colors group">
                        <td class="px-6 py-4 border-r border-slate-200 dark:border-slate-700/50 text-sm font-bold text-slate-600 dark:text-slate-500">2</td>
                        <td class="px-6 py-4 text-sm font-bold text-slate-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex item-center justify-end gap-3">
                                ...
                                <a href="{{route('offices.zeo.profile.institutions-list', $officeId)}}" class="transform text-slate-500 hover:text-red-500 dark:text-slate-500 dark:hover:text-red-400 transition-colors hover:scale-110">
                                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-filetype-pdf" viewBox="0 0 16 16">
                                        <path fill-rule="evenodd" d="M14 4.5V14a2 2 0 0 1-2 2h-1v-1h1a1 1 0 0 0 1-1V4.5h-2A1.5 1.5 0 0 1 9.5 3V1H4a1 1 0 0 0-1 1v9H2V2a2 2 0 0 1 2-2h5.5zM1.6 11.85H0v3.999h.791v-1.342h.803q.43 0 .732-.173.305-.175.463-.474a1.4 1.4 0 0 0 .161-.677q0-.375-.158-.677a1.2 1.2 0 0 0-.46-.477q-.3-.18-.732-.179m.545 1.333a.8.8 0 0 1-.085.38.57.57 0 0 1-.238.241.8.8 0 0 1-.375.082H.788V12.48h.66q.327 0 .512.181.185.183.185.522m1.217-1.333v3.999h1.46q.602 0 .998-.237a1.45 1.45 0 0 0 .595-.689q.196-.45.196-1.084 0-.63-.196-1.075a1.43 1.43 0 0 0-.589-.68q-.396-.234-1.005-.234zm.791.645h.563q.371 0 .609.152a.9.9 0 0 1 .354.454q.118.302.118.753a2.3 2.3 0 0 1-.068.592 1.1 1.1 0 0 1-.196.422.8.8 0 0 1-.334.252 1.3 1.3 0 0 1-.483.082h-.563zm3.743 1.763v1.591h-.79V11.85h2.548v.653H7.896v1.117h1.606v.638z" />
                                    </svg>
                                </a>
                    ...
                    <tr class="hover:bg-slate-50/50 dark:hover:bg-indigo-700/30 transition-colors group">
                        <td class="px-6 py-4 border-r border-slate-200 dark:border-slate-700/50 text-sm font-bold text-slate-600 dark:text-slate-500">3</td>
                        <td class="px-6 py-4 text-sm font-bold text-slate-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex item-center justify-end gap-3">
                                ...
                                <a href="{{route('pdf.zeo-staff-list', $officeId)}}" target="_blank" class="transform text-slate-500 hover:text-red-500 dark:text-slate-500 dark:hover:text-red-400 transition-colors hover:scale-110">
                                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-filetype-pdf" viewBox="0 0 16 16">
                                        <path fill-rule="evenodd" d="M14 4.5V14a2 2 0 0 1-2 2h-1v-1h1a1 1 0 0 0 1-1V4.5h-2A1.5 1.5 0 0 1 9.5 3V1H4a1 1 0 0 0-1 1v9H2V2a2 2 0 0 1 2-2h5.5zM1.6 11.85H0v3.999h.791v-1.342h.803q.43 0 .732-.173.305-.175.463-.474a1.4 1.4 0 0 0 .161-.677q0-.375-.158-.677a1.2 1.2 0 0 0-.46-.477q-.3-.18-.732-.179m.545 1.333a.8.8 0 0 1-.085.38.57.57 0 0 1-.238.241.8.8 0 0 1-.375.082H.788V12.48h.66q.327 0 .512.181.185.183.185.522m1.217-1.333v3.999h1.46q.602 0 .998-.237a1.45 1.45 0 0 0 .595-.689q.196-.45.196-1.084 0-.63-.196-1.075a1.43 1.43 0 0 0-.589-.68q-.396-.234-1.005-.234zm.791.645h.563q.371 0 .609.152a.9.9 0 0 1 .354.454q.118.302.118.753a2.3 2.3 0 0 1-.068.592 1.1 1.1 0 0 1-.196.422.8.8 0 0 1-.334.252 1.3 1.3 0 0 1-.483.082h-.563zm3.743 1.763v1.591h-.79V11.85h2.548v.653H7.896v1.117h1.606v.638z" />
                                    </svg>
                                </a>
