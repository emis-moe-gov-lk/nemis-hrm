<section class="w-full">
    <x-offices.zeo.zeo-layout :officeId="$officeId">
        ...
        <div class="mx-auto">
            <div class="relative overflow-hidden rounded-3xl border border-slate-300 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-900 md:p-10">
                ...
                <form wire:submit.prevent="updateInstitutionGroup" class="relative z-10 space-y-8">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="mt-1 flex items-center gap-3 rounded-lg border border-slate-300 bg-slate-50 p-3 dark:border-slate-700 dark:bg-slate-800/50">
                            <div class="flex-1">
