<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <x-page-header
            ...
            subtitle="Manage and filter institution cadre details"
        ...
        {{-- Filter Section --}}
        <section class="bg-zinc-50/50 dark:bg-zinc-900/50 p-4 rounded-2xl border border-zinc-200 dark:border-zinc-700 shadow-sm">
        ...
        <div class="flex items-center justify-between px-2">
            <span class="text-xs font-black uppercase tracking-widest text-zinc-400 dark:text-zinc-400">
        ...
        <div class="space-y-3">
            ...
            <a href="{{ route('cadre-dms-approved.view', $institution->id) }}" class="block group">
                <div class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 rounded-2xl p-4 transition-all duration-300 hover:shadow-md hover:border-blue-300 dark:hover:border-blue-700/50">
                    <div class="flex flex-col lg:flex-row gap-4">
                        ...
                        <div class="flex items-start gap-4 flex-1">
                            ...
                            <div class="space-y-1 min-w-0">
                                ...
                                <div class="flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-zinc-400 dark:text-zinc-400 font-medium">
            ...
            @empty
            <div class="flex flex-col items-center justify-center p-12 bg-white dark:bg-zinc-900/50 border border-dashed border-zinc-300 dark:border-zinc-700 rounded-2xl">
                ...
                <p class="text-zinc-400 dark:text-zinc-400 text-sm mt-1">{{ __('Try adjusting your filters or search query.') }}</p>
            </div>
            @endforelse
        </div>
