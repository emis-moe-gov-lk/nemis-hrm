<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
    ...
    <x-alerts.layout>
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div class="group relative isolate min-h-[260px] py-8 flex flex-col items-center justify-center rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 overflow-hidden">
                ...
                <div class="relative z-10 flex flex-col items-center p-4 w-full h-full justify-center">
                    ...
                    <span class="text-sm font-semibold text-zinc-400 dark:text-zinc-400 mb-5 text-center">Pending Confirmation</span>
            ...
            <div class="group relative isolate min-h-[260px] py-8 flex flex-col items-center justify-center rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 overflow-hidden">
                ...
                <div class="relative z-10 flex flex-col items-center p-4 w-full h-full justify-center">
                    ...
                    <span class="text-sm font-semibold text-zinc-400 dark:text-zinc-400 mb-5 text-center">Pending Verification</span>
