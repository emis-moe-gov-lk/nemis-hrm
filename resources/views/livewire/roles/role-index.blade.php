<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
    ...
    <x-page-header
        title="Roles List"
        subtitle="Manage role profiles and permissions"
        icon="shield-check">
        <x-slot:actions>
    ...
    <div class="grid grid-cols-1 gap-4">
        ...
        <div class="group bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-3xl p-5 transition-all duration-300 hover:shadow-xl">
            <div class="flex flex-col space-y-4">
                ...
                <div class="flex items-start justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <span class="text-[10px] font-black text-slate-500 uppercase tracking-widest">ID: {{ $role->id }}</span>
                        </div>
                    </div>
                ...
                <div x-data="{ open: false }" class="border border-slate-200 dark:border-slate-700 rounded-2xl overflow-hidden">
                    <button
                        @click="open = !open"
                        class="w-full flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800/50 hover:bg-slate-100 dark:hover:bg-indigo-700 transition-colors">
                        <div class="flex items-center gap-2">
                            <flux:icon.key variant="micro" class="size-4 text-slate-500" />
                        ...
                        <flux:icon.chevron-down
                            variant="micro"
                            class="size-4 text-slate-500 transition-transform duration-300"
                    ...
                    <div
                        ...
                        @else
                        <p class="text-xs italic text-slate-500">No permissions assigned to this role.</p>
                        @endif
                    </div>
                </div>
            </div>
        ...
        @empty
        <div class="flex flex-col items-center justify-center py-20 bg-slate-50 dark:bg-slate-800/50 rounded-[2.5rem] border-2 border-dashed border-slate-300 dark:border-slate-700 text-center">
