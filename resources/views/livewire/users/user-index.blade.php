<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
    ...
    <div class="space-y-3">
        ...
        <div class="group bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-2xl p-4 transition-all duration-200 hover:shadow-md hover:border-indigo-500/30">
            <div class="flex flex-col md:flex-row md:items-center gap-6">
                ...
                <div class="flex items-center gap-4 min-w-[280px] lg:w-1/4">
                    <div class="relative shrink-0">
                        <div class="h-12 w-12 rounded-full ring-2 ring-slate-100 dark:ring-slate-800 bg-indigo-50 dark:bg-indigo-500/10 flex items-center justify-center">
                            <flux:icon.user variant="mini" class="text-indigo-600 dark:text-indigo-400" />
                        </div>
                ...
                <div class="flex flex-col sm:flex-row sm:items-center gap-4 lg:gap-8 flex-1">
                    <div class="flex items-center gap-2 text-slate-500 dark:text-slate-500 min-w-[200px]">
                        <flux:icon.envelope variant="micro" class="size-4 text-slate-500" />
                        <span class="text-sm truncate">{{ $user->email }}</span>
                    </div>
                    <div class="flex items-center gap-2 text-slate-500 dark:text-slate-500">
                        <flux:icon.building-office variant="micro" class="size-4 text-slate-500" />
                        <span class="text-[11px] font-bold uppercase tracking-tight truncate max-w-[150px]">
                            {{ $user->currentAppointment?->workplace?->office_name ?? 'No Workplace' }}
                        </span>
                    </div>
                </div>
                ...
                <div class="flex flex-wrap gap-1.5 lg:w-1/6">
                    ...
                    @empty
                    <span class="text-[10px] text-slate-500 font-bold uppercase">No Role</span>
                    @endforelse
                </div>
