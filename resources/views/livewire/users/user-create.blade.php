<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
    <x-page-header
        ...
        subtitle="Onboard a new member to the system and assign access roles."
        icon="user-plus"
        :breadcrumbs="[
            'Registry' => '#',
    ...
    <form wire:submit="createUser" class="space-y-8">
        ...
        <section class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="md:col-span-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-4xl p-6 shadow-sm space-y-4">
