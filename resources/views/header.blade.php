<header
    ...
    <div class="max-w-7xl mx-auto flex items-center justify-between px-6 py-3">
        ...
        <a href="{{ route('home') }}" class="inline-flex items-center">
            ...
            <span class="ml-3 text-xl font-bold text-white tracking-wide hidden sm:inline">
                <span class="text-blue-300">E</span>ducation <span class="text-blue-300">M</span>anagement <span class="text-blue-300">I</span>nformation <span class="text-blue-300">S</span>ystem
            </span>
