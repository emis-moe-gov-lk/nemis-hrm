...
return new class extends Migration
{
    ...
    {
        Schema::create('teacher_transfer_board_member_attendances', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('tbm_id', 'tbma_member_fk')
                ->references('tbm_id')
                ->on('teacher_transfer_board_members')
                ->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('teacher_transfer_board_member_attendances');
    }
};
